...
export function createJournalGateway(api) {
  return {
    ...
    autoConnectPlaid: () => api.finance.autoConnect(),
    savePlaidCredentials: (credentials) => api.finance.savePlaidCredentials(credentials),
    connectPlaid: () => api.finance.connectPlaid(),
