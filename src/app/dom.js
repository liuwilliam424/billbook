...
export function getElements() {
  return {
    ...
    connectPlaidButton: document.querySelector("#connect-plaid-button"),
    ...
    plaidStatus: document.querySelector("#plaid-status"),
    ...
    plaidCredentialsDialog: document.querySelector("#plaid-credentials-dialog"),
    plaidClientIdInput: document.querySelector("#plaid-client-id"),
    plaidSecretInput: document.querySelector("#plaid-secret"),
    plaidEnvironmentInput: document.querySelector("#plaid-environment"),
    plaidCancelButton: document.querySelector("#plaid-cancel-button"),
    plaidSaveButton: document.querySelector("#plaid-save-button"),
